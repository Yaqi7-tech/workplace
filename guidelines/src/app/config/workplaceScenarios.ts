...
export const THEME_COLORS = {
  red: 'rgb(252, 117, 123)',           // #FC757B
  orange: 'rgb(249, 127, 95)',         // #F97F5F
  lightOrange: 'rgb(250, 162, 111)',   // #FAA26F
  yellowLight: 'rgb(253, 205, 148)',   // #FDCD94
  yellow: 'rgb(254, 225, 153)',        // #FEE199
  greenLight: 'rgb(176, 214, 169)',    // #B0D6A9
  cyan: 'rgb(101, 189, 186)',          // #65BDBA
  blue: 'rgb(60, 155, 201)'            // #3C9BC9
};

// 人设配置
export const PERSONA_CARDS: Record<PersonaType, {
  title: string;
  name: string;  // 英文名字，方便用户称呼
...
export const SCENARIO_CARDS: Record<ScenarioType, {
  ...
  "职场闲聊": {
    ...
    difficulty: "easy",
    icon: "💬",
    color: THEME_COLORS.greenLight
  }
};

// 获取组合Prompt（用于初始化对话 - 人设和场景在一个API调用中）
...
export const DIFFICULTY_LABELS = {
  easy: { label: "入门", color: "bg-[rgb(176,214,169)] text-green-900" },
  medium: { label: "进阶", color: "bg-[rgb(254,225,153)] text-yellow-900" },
  hard: { label: "挑战", color: "bg-[rgb(252,117,123)] text-red-900" }
};
